...
const Footer = () => {
  ...
  const getGridClass = () => {
    if (screenSize.width >= 1024) return "grid-cols-4";
    if (screenSize.width >= 640) return "grid-cols-2";
    return "grid-cols-1";
  };
    ...
    <footer className="bg-black text-white p-6 pt-9">
      <div className={`container mx-auto text-center grid gap-8 ${getGridClass()}`}>
        ...
        <div>
          ...
          <div className="flex flex-col items-center space-y-4">
            <a
              href="https://www.facebook.com/profile.php?id=61574524575336"
              target="_blank"
            ...
            <a
              href="https://www.instagram.com/buildyourvision_"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center hover:text-gray-400 space-x-2 transition"
            >
            ...
            <a
              href="https://www.youtube.com/@buildyour_vision"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center hover:text-gray-400 space-x-2 transition"
            >
            ...
            <a
              href="import React, { useState, useEffect } from "react";
import { Link } from "react-router-dom";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import {
  faFacebook,
      ...
      <div className={`container mx-auto text-center grid gap-8 ${getGridClass()}`}>
        ...
        <div>
          ...
          <div className="flex flex-col items-center space-y-4">
            ...
            <a
              href="https://x.com/BuildUrVision_" // Replace with your X (Twitter) handle
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center hover:text-gray-400 space-x-2 transition"
            >
            ...
            <a
              href="https://www.linkedin.com/in/harsha-reddy-28bb39356" // Replace with your LinkedIn page
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center hover:text-gray-400 space-x-2 transition"
            >
...
export default Footer;
" // Replace with your X (Twitter) handle
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center hover:text-gray-400 space-x-2 transition"
            >
            ...
            <a
              href="https://www.linkedin.com/company/buildyourvision" // Replace with your LinkedIn page
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center hover:text-gray-400 space-x-2 transition"
            >
